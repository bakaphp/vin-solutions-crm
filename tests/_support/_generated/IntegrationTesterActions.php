<?php  //[STAMP] 78ed41acd9bc3a3e0c0fb035b0d85234
...
trait IntegrationTesterActions
{
     ...
     *
     * @return void
     * @see \Helper\Integration::setDi()
     */
    public function setDi() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('setDi', func_get_args()));
    }
     ...
     *
     * @return mixed
     * @see \Helper\Integration::grabDi()
     */
    public function grabDi() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabDi', func_get_args()));
    }
     ...
     *
     * @return mixed
     * @see \Helper\Integration::grabFromDi()
     */
    public function grabFromDi(string $name) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabFromDi', func_get_args()));
    }
     ...
     * @param string $name
     * @param mixed  $service
     * @see \Helper\Integration::haveService()
     */
    public function haveService(string $name, $service) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveService', func_get_args()));
    }
     ...
     *
     * @param string $name
     * @see \Helper\Integration::removeService()
     */
    public function removeService(string $name) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('removeService', func_get_args()));
    }
}
